...
def _build_time_matrix(locations: list[dict], speed_kmh: float, detour_factor: float) -> list[list[int]]:
...
def _build_distance_matrix(locations: list[dict], detour_factor: float) -> list[list[float]]:
